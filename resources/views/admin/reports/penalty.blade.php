...
@section('content')
    ...
    <div class="content">
        ...
        <div class="card">
            <!-- Product form -->
            <form action="{{ route('get-penalty-report') }}" class="flex-fill form-validate-jquery">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card mb-0">
                    ...
                    <table id="datatables-buttons" class="table table-bordered table-responsive">
                        ...
                        @foreach($penaltyData as $row)
                            <tr>
                                ...
                                <td>{{ number_format($row['days_late'], 2) }}</td>
                                <td>{{ number_format($row['penalty_per_day'], 2) }}</td>
                                <td>{{ number_format($row['total_penalty'], 2) }}</td>
