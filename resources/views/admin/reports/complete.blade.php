...
@section('content')
    ...
    <div class="content">
        ...
        <div class="card">
            <!-- Product form -->
            <form action="{{ route('get-complete-report') }}" class="flex-fill form-validate-jquery">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card mb-0">
            ...
            <div class="card">
                <div class="card-body">
                    <table id="datatables-buttons" class="table table-bordered">
                        ...
                        <tbody>
                        @foreach($result as $loanApplication)
                            <tr>
                                <td>{{ $loanApplication->application_id ?? 'N/A' }}</td>
                                <td>{{ $loanApplication->user->name ?? 'N/A' }}</td>
                                <td>{{ $loanApplication->user->profile->cnic_no ?? 'N/A' }}</td>
                                <td>{{ $loanApplication->user->profile->gender->name ?? 'N/A' }}</td>
                                <td>{{ $loanApplication->user->province->name ?? 'N/A' }}</td>
                                <td>{{ $loanApplication->user->district->name ?? 'N/A' }}</td>
                                <td>{{ $loanApplication->product->name ?? 'N/A' }}</td>
                                <td>{{ number_format($loanApplication->loan_amount, 2) }}</td>
                                <td>{{ number_format($loanApplication->transaction->amount, 2) }}</td>
