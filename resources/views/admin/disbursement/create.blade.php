                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <p><strong>Expire Date:</strong> {{ showDate($loanApplication->user->profile->expire_date) }}</p>
                            ...
                            <p><strong>Alternate Mobile No:</strong> {{ $loanApplication->user->profile->alternate_mobile_no }}</p>
                            <p><strong>Permanent Address:</strong> {{ $loanApplication->user->profile->permanent_address }}</p>
                            <p><strong>Current Address:</strong> {{ $loanApplication->user->profile->current_address }}</p>
                            <p><strong>Current Address Duration:</strong> {{ $loanApplication->user->profile->residenceDuration->name }}
                            <p><strong>Current Residence:</strong> {{ $loanApplication->user->profile->residenceType->name }}
                            </p>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <label class="col-form-label">Service/API <span class="text-danger">*</span></label>
                                        <div class="form-group form-group-feedback form-group-feedback-right">
                                            <select name="service_api" class="form-control select2" required>
                                                <option value="">Select Service/API</option>
                                                <option value="jazz_cash">Jazz Cash (Disburse/Collection)</option>
