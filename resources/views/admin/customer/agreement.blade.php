            ...
            <div class="card">
                ...
                <div class="card-body px-4">
                    ...
                    <div class="agreement-content">
                        ...
                        <p>1.3. A Handling fee of <strong>{{ $loanApplicationProduct->processing_fee_percentage }}
                                %</strong>
                            of the
                            Loan Amount will be deducted at the time of disbursement.</p>
                        <p>1.4. The Borrower will provide <b>post-dated cheques</b> for the full Loan Amount and
                            scheduled
                            installments at the time of signing this Agreement,
                            ensuring compliance with the repayment terms. OR The Guarantor agrees to provide a personal
                            guarantee for the repayment of the loan and will also be jointly liable for any
                            non-repayment or default by the Borrower, as outlined in Clause 7.</p>
                        ...
                        <p>2.1. The Loan Amount shall accrue interest on the outstanding principal balance at a rate
                            proportional to
                            the agreed loan term, calculated on a pro-rata basis relative to the duration of the loan
                            period
                        ...
                        <p>2.2. The Loan Amount, including interest, shall be repaid in
                            ...
                            of each month.</p>
                        <p>2.3. Late payments shall incur a <strong>penalty fee of PKR {{env('LATE_FEE')}} per
                                day</strong>,
                            calculated from the day after the
                            installment due date.</p>
                        <p>2.4. In case the Borrower fails to make payments for <b>90 days</b>, the Lender has the right
                            to
                            present
                            the
                        ...
                        <p>3.1. The Borrower agrees to repay the Loan Amount in full, along with applicable interest, as
                            per
                            the
                        ...
                        <p>
                        <p>Account Title: SARMAYA MICROFINANCE PVT LTD. </p>
                        <p>Account No : 0002369168 </p>
                        <p>IBAN No : PK21JSBL9571000002369168 </p>
                        <p>JS Bank Limited </p>
                        <p>ISE Tower Branch JINNAH Avenue Islamabad </p>
                        </p>
                        </p>
                        <p>(b) Mobile Wallet Payment via JazzCash/Easypaisa or any other approved payment gateway
                            integrated into the mobile app.</p>
                        <p>(c) Auto-Debit from the Borrower’s designated bank account, subject to the Borrower’s
                            explicit consent and activation of this feature.</p>
                        <p>(d) Post-Dated Cheques, which will be presented for payment on the agreed due dates.</p>

                        <b>Note: Auto-debit will only be activated upon the Borrower’s written authorization or digital
                            consent through the mobile app.</b>
                        </p>
                        ...
                        <p>4.2. In the event of default by the Borrower, the Guarantor will be held liable to repay the
                            Loan
                            Amount
                            immediately.</p>
                        <p>4.3. The Lender may take legal action against the Guarantor if the Borrower fails to repay,
                            and
                            the
                            Guarantor fails to fulfill their obligations under this Agreement.</p>
                        <p>4.4 The Guarantor will receive a written notice from the Lender in case of the Borrower’s
                            default. The notice will provide details of the outstanding amount and the repayment
                            timeline. The Guarantor may request an installment plan for repayment, subject to the
                            Lender’s approval, to fulfill their obligations under this Agreement.</p>

                        <h4>5. Late Payment Charges</h4>
                        <p>5.1. In the event that the Borrower fails to repay any installment by the due date, a late
                            payment
                            charge of <strong>PKR {{env('LATE_FEE')}} per day</strong> will apply until the installment
                            is
                            paid in
                            full.</p>
                        ...
                        <p>5.3. The Borrower shall bear all legal and collection costs incurred by the Lender in
                            enforcing
                            this
                        ...
                        <p>6.2. Should any cheque be dishonored, the Borrower will be liable for legal penalties under
                            the
                            <strong>Negotiable Instruments Act, 1881,</strong> and all costs associated with the
                            recovery of
                            the Loan Amount.</p>
                        <p>6.3. Dishonoring a cheque will result in the immediate acceleration of all remaining
                            payments,
                        ...
                        <p>(b) Initiate legal proceedings to recover the outstanding Loan Amount from the Borrower
                            and/or
                            the Guarantor.</p>
                        ...
                        <p>7.3. The Guarantor will be fully liable for the Loan Amount in case of the Borrower's
                            default,
                            and the Lender may recover dues directly from the Guarantor without first exhausting
                            remedies
                            against the Borrower.</p>

                        <h4>8. Prepayment</h4>
                        <h4>Prepayment of Loan</h4>
                        <p>
                        <p> 8.1. The Borrower may prepay the outstanding Loan Amount in full or in part at any time,
                            subject to the following conditions:</p>
                        <p> a. If the prepayment is made within three (3) months of the Loan disbursement date, a
                            prepayment charge of ten percent (10%) of the outstanding Loan Amount will be applied.</p>
                        <p> b. If the prepayment is made after three (3) months of the Loan disbursement date, a
                            prepayment charge of five percent (5%) of the outstanding Loan Amount will be applied.</p>


                        </p>
                        <p>8.2. Interest will be calculated up to the date of prepayment, and no further interest will
                            accrue on the prepaid amount after the prepayment date..</p>
                        <p>8.3. Prepayments will not incur any other penalties or fees beyond the applicable prepayment
                            charge stated above.</p>


                        <h4>9. Use of Loan</h4>
                        <p>9.1. The Borrower agrees to use the Loan Amount exclusively for the following purpose(s):
                            <strong>{{ $loanApplication->loanPurpose->name }}</strong>.
                        <p>The Borrower shall provide documentation or evidence of proper utilization upon request.
                            Misuse of the Loan Amount, including but not limited to illegal activities or purposes not
                            specified in this Agreement, will constitute a breach of contract and may lead to immediate
                            termination of the loan facility and recovery action.</p>
                        </p>
                        <p>9.2. Any misuse of the Loan Amount for purposes not agreed upon will constitute a breach of
                            this Agreement and may lead to immediate termination of the loan facility.</p>
                        <p>
                        <p>9.3. Misuse of the Loan Amount, determined through audit or investigation, will result
                            in: </p>
                        <p>(a) Immediate repayment of the outstanding amount along with a penalty of 15% of the Loan
                            Amount. </p>
                        <p>(b) Termination of the loan facility, and </p>
                        <p>(c) Legal action under applicable laws </p>
                        </p>

                        <p>
                        <p>9.4. <b>Appendices</b></p>
                        <p>Attach the following to the agreement for clarity: </p>
                        <p>● Appendix A: Sample Loan Repayment Schedule. </p>
                        <p>● Appendix B: Contact Information for Dispute Resolution. </p>
                        </p>
                        ...
                        <p>11.2. Any modifications to the terms of this Agreement will be communicated to the Borrower
                            via
                            email or through the mobile app.</p>

                        <h4>12. Termination</h4>
                        <p>12.1. This Agreement shall terminate upon full repayment of the Loan Amount, including
                            interest
                            and any additional fees, by the Borrower or the Guarantor.</p>
                        <p>12.2. The Lender reserves the right to terminate this Agreement immediately upon the
                            Borrower's
                        ...
                        <p>14.1. The Borrower and Guarantor agree to receive communications, including loan
                            notifications
                            and payment reminders, through the mobile app and email.</p>
                        <p>14.2. If any provision of this Agreement is found invalid or unenforceable by a court of law,
                            the
                        ...
                        <p>By signing this Agreement digitally via the mobile application, the Borrower and Guarantor
                            acknowledge and agree to the terms and conditions stated herein. The digital signature
                            process adheres to secure encryption standards to protect the Borrower’s and Guarantor’s
                            data and ensure the authenticity of this Agreement.</p>
                        ...
                        <div class="row signature-section">
                            ...
                            <div class="col-6">
                                ...
                                <p>
                                    <strong>{{$customer->profile->first_name .' ' . $customer->profile->last_name}}</strong>
                                </p>
                                <p>Signature: ___________________</p>
                                <p>Date: {{currentDate()}}</p>
                            </div>
