                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <select name="is_nacta_clear" class="form-control select2"
                                                ...
                                                <option></option>
                                                <option {{ old('is_nacta_clear' , $customer->is_nacta_clear) == 1 ? 'selected' : '' }} value="1">YES</option>
                                                <option {{ old('is_nacta_clear' , $customer->is_nacta_clear) == 0 ? 'selected' : '' }} value="0">No</option>
                                            </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="guarantor_contact_name[]" class="form-control"
                                               ...
                                               value="{{ isset($customer->references[1]) ? $customer->references[1]->guarantor_contact_name : '' }}">
                                        @if ($errors->has('guarantor_contact_name'))
                                            <span
                                                class="text-danger">{{ $errors->first('guarantor_contact_name') }}</span>
                                        @endif
